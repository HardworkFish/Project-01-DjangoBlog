! function (e) {
    var t;
    "undefined" != typeof window ? t = window : "undefined" != typeof self && (t = self), t.ALGOLIA_MIGRATION_LAYER = function e(t, o, r) {
        function n(s, a) {
            if (!o[s]) {
                if (!t[s]) {
        ...
        1: [
            function (e, t, o) {
                ...
                t.exports = function (e, t, o) {
                    ...
                    "function" == typeof t && (o = t, t = {}), t = t || {}, o = o || function () {}, s.type = t.type || "text/javascript", s.charset = t.charset || "utf8", s.async = !("async" in t && !t.async), s.src = e, t.attrs && function (e, t) {
                        for (var o in t) e.setAttribute(o, t[o])
                    }(s, t.attrs), t.text && (s.text = "" + t.text);
                    var a = "onload" in s ? r : n;
                    a(s, o), s.onload || r(s, o), i.appendChild(s)
                }
            }, {}
        ],
        2: [
        ...
        3: [
            function (e, t, o) {
                ...
                t.exports = function (t) {
                    ...
                    try {
                        document.write("<script>window.ALGOLIA_SUPPORTS_DOCWRITE = true<\/script>"), !0 === window.ALGOLIA_SUPPORTS_DOCWRITE ? (document.write('<script src="' + n + '"><\/script>'), r("document.write")()) : o(n, r("DOMElement"))
                    } catch (e) {
                        o(n, r("DOMElement"))
                    }
                }
    ...
    return function e(t, o, r) {
                ...
                function r(e) {
                    function t() {
                        if (t.enabled) {
                            ...
                            s[0] = o.coerce(s[0]), "string" != typeof s[0] && s.unshift("%O");
                            var c = 0;
                            s[0] = s[0].replace(/%([a-zA-Z%])/g, function (t, r) {
                                ...
                                return t
                            }), o.formatArgs.call(e, s);
                            (t.log || o.log || console.log.bind(console)).apply(e, s)
                        }
                    }
                    return t.namespace = e, t.enabled = o.enabled(e), t.useColors = o.useColors(), t.color = function (e) {
                        var t, r = 0;
                        for (t in e) r = (r << 5) - r + e.charCodeAt(t), r |= 0;
                        return o.colors[Math.abs(r) % o.colors.length]
                    }(e), "function" == typeof o.init && o.init(t), t
                }(o = t.exports = r.debug = r.default = r).coerce = function (e) {
                    ...
                    return !1
                }, o.humanize = e(9), o.names = [], o.skips = [], o.formatters = {};
                var n
            }, {
                9: 9
            }
            ...
            function (e, t, o) {
                (function (r, n) {
                    i = this, s = function () {
                        ...
                        function l(e, o, r) {
                            o.constructor === e.constructor && r === s && o.constructor.resolve === a ? (c = e, (u = o)._state === N ? h(c, u._result) : u._state === D ? f(c, u._result) : y(u, void 0, function (e) {
                                return p(c, e)
                            }, function (e) {
                                return f(c, e)
                            })) : r === L ? (f(e, L.error), L.error = null) : void 0 === r ? h(e, o) : t(r) ? (n = o, i = r, A(function (e) {
                                var t = !1,
                                    o = function (e, t, o, r) {
                                        try {
                                            e.call(t, o, r)
                        ...
                        function h(e, t) {
                            e._state === C && (e._result = t, e._state = N, 0 !== e._subscribers.length && A(m, e))
                        }

                        function f(e, t) {
                            e._state === C && (e._state = D, e._result = t, A(d, e))
                        }

                        function y(e, t, o, r) {
                            var n = e._subscribers,
                                i = n.length;
                            e._onerror = null, n[i] = t, n[i + N] = o, n[i + D] = r, 0 === i && e._state && A(m, e)
                        }
                        ...
                        function m(e) {
                            var t = e._subscribers,
                                o = e._state;
                            if (0 !== t.length) {
                                for (var r = void 0, n = void 0, i = e._result, s = 0; s < t.length; s += 3) r = t[s], n = t[s + o], r ? g(o, r, n, i) : n(i);
                        ...
                        function g(e, o, r, n) {
                            ...
                            if (i) {
                                ...
                                }(r, n)) === K ? (u = !0, a = s.error, s.error = null) : c = !0, o === s) return void f(o, new TypeError("A promises callback cannot return that same promise."))
                            } else s = n, c = !0;
                            o._state !== C || (i && c ? p(o, s) : u ? f(o, a) : e === N ? h(o, s) : e === D && f(o, s))
                        }

                        function b(e) {
                            e[q] = H++, e._state = void 0, e._result = void 0, e._subscribers = []
                        }
                        ...
                        function _(e) {
                            this[q] = H++, this._result = this._state = void 0, this._subscribers = [], c !== e && ("function" != typeof e && function () {
                        ...
                        var x = Array.isArray ? Array.isArray : function (e) {
                            ...
                            j = void 0,
                            A = function (e, t) {
                                E[T] = e, E[T + 1] = t, 2 === (T += 2) && (j ? j(i) : P())
                            },
                            S = "undefined" != typeof window ? window : void 0,
                            I = S || {},
                            k = I.MutationObserver || I.WebKitMutationObserver,
                            O = "undefined" == typeof self && void 0 !== r && "[object process]" === {}.toString.call(r),
                        ...
                        }() : void 0 === S && "function" == typeof e ? function () {
                            try {
                                var t = e("vertx");
                        ...
                        return w.prototype._enumerate = function (e) {
                            ...
                            if (r === a) {
                                var n = u(e);
                                if (n === s && e._state !== C) this._settledAt(e._state, t, e._result);
                                else if ("function" != typeof n) this._remaining--, this._result[t] = e;
                                else if (o === _) {
                                    var i = new o(c);
                                    l(i, e, n), this._willSettleAt(i, t)
                                } else this._willSettleAt(new o(function (t) {
                                    return t(e)
                                }), t)
                            } else this._willSettleAt(r(e), t)
                        }, w.prototype._settledAt = function (e, t, o) {
                            var r = this.promise;
                            r._state === C && (this._remaining--, e === D ? f(r, o) : this._result[t] = o), 0 === this._remaining && h(r, this._result)
                        }, w.prototype._willSettleAt = function (e, t) {
                            var o = this;
                            y(e, void 0, function (e) {
                                return o._settledAt(N, t, e)
                            }, function (e) {
                    ...
                    }, "object" == typeof o && void 0 !== t ? t.exports = s() : i.ES6Promise = s();
                    var i, s
            ...
            function (e, t, o) {
                ...
                t.exports = r, r.EventEmitter = r, r.prototype._events = void 0, r.prototype._maxListeners = void 0, r.defaultMaxListeners = 10, r.prototype.setMaxListeners = function (e) {
                    ...
                    default:
                        ...
                        for (a = Array.prototype.slice.call(arguments, 1), u = o.slice(), r = u.length, c = 0; c < r; c++) u[c].apply(this, a);
                    return !0
                    ...
                    if (s = (o = this._events[e]).length, r = -1, o === t || n(o.listener) && o.listener === t) delete this._events[e], this._events.removeListener && this.emit("removeListener", e, t);
                    else if (i(o)) {
                        for (a = s; a-- > 0;)
                    ...
                    if (n(o = this._events[e])) this.removeListener(e, o);
                    else if (o)
        ...
        9: [
            function (e, t, o) {
                ...
                t.exports = function (e, t) {
                    ...
                    if ("number" === o && !1 === isNaN(e)) return t.long ? (l = e, r(l, a, "day") || r(l, s, "hour") || r(l, i, "minute") || r(l, n, "second") || l + " ms") : (u = e, u >= a ? Math.round(u / a) + "d" : u >= s ? Math.round(u / s) + "h" : u >= i ? Math.round(u / i) + "m" : u >= n ? Math.round(u / n) + "s" : u + "ms");
                    var u, l;
                ...
                var r = Object.prototype.hasOwnProperty,
                    ...
                    f = function (e) {
                        ...
                        if (i && e.length > 0)
                            ...
                            for (var v in e) f && "prototype" === v || !r.call(e, v) || d.push(String(v)); if (c)
                            ...
                            }(e), b = 0; b < l.length; ++b) g && "constructor" === l[b] || !r.call(e, l[b]) || d.push(l[b]);
                        return d
                    };
                f.shim = function () {
                    if (Object.keys) {
        ...
        12: [
            function (e, t, o) {
                ...
                function s() {
                    y && h && (y = !1, h.length ? f = h.concat(f) : m = -1, f.length && a())
                }
                ...
                d.nextTick = function (e) {
                    ...
                    f.push(new c(e, t)), 1 !== f.length || y || i(a)
        ...
        14: [
            function (e, t, o) {
                ...
                u(r, c), r.prototype.deleteIndex = function (e, t) {
                ...
                }, r.prototype.copyIndex = function (e, t, o, r) {
                    var n = {
                            operation: "copy",
                            destination: t
                        },
                    ...
                    else if (Array.isArray(o) && o.length > 0) n.scope = o;
                    else if (void 0 !== o) throw new Error("the scope given to `copyIndex` was not an array with settings, synonyms or rules");
                    return this._jsonRequest({
                        method: "POST",
                        url: "/1/indexes/" + encodeURIComponent(e) + "/operation",
                        body: n,
                    ...
                    return o && (n.validity = o.validity, n.maxQueriesPerIPPerHour = o.maxQueriesPerIPPerHour, n.maxHitsPerQuery = o.maxHitsPerQuery, n.indexes = o.indexes, n.description = o.description, o.queryParameters && (n.queryParameters = this._getSearchParams(o.queryParameters, "")), n.referers = o.referers), this._jsonRequest({
                        method: "POST",
                        url: "/1/keys",
                        body: n,
                        hostType: "write",
                    ...
                    if (!e(8)(o)) throw new Error("Usage: client.updateApiKey(key, arrayOfAcls[, params, callback])");
            ...
            function (e, t, o) {
                (function (o) {
                    function r(t, o, r) {
                        ...
                        if (!0 !== r._allowEmptyCredentials && !t) throw new a.AlgoliaSearchError("Please provide an application ID. " + l);
                        if (!0 !== r._allowEmptyCredentials && !o) throw new a.AlgoliaSearchError("Please provide an API key. " + l);
                        this.applicationID = t, this.apiKey = o, this.hosts = {
                            read: [],
                            write: []
                        };
                        var p = (r = r || {}).protocol || "https:";
                        if (this._timeouts = r.timeouts || {
                            connect: 1e3,
                            read: 2e3,
                            write: 3e4
                        }, r.timeout && (this._timeouts.connect = this._timeouts.read = this._timeouts.write = r.timeout), /:$/.test(p) || (p += ":"), "http:" !== r.protocol && "https:" !== r.protocol) throw new a.AlgoliaSearchError("protocol must be `http:` or `https:` (was `" + r.protocol + "`)");
                        if (this._checkAppIdData(), r.hosts) c(r.hosts) ? (this.hosts.read = s(r.hosts), this.hosts.write = s(r.hosts)) : (this.hosts.read = s(r.hosts.read), this.hosts.write = s(r.hosts.write));
                        else {
                    ...
                    var a = e(28),
                        ...
                        u = e(18),
                        l = e(34),
                        p = o.env.RESET_APP_DATA_TIMER && parseInt(o.env.RESET_APP_DATA_TIMER, 10) || 12e4;
                    r.prototype.initIndex = function (e) {
                        return new u(this, e)
                        ...
                        var o, r, n = e(1)("algoliasearch:" + t.url),
                            u = t.additionalUA || "",
                            l = t.cache,
                            p = this,
                            d = 0,
                            h = !1,
                            f = p._useFallback && p._request.fallback && t.fallback;
                        this.apiKey.length > 500 && void 0 !== t.body && (void 0 !== t.body.params || void 0 !== t.body.requests) ? (t.body.apiKey = this.apiKey, r = this._computeRequestHeaders({
                            additionalUA: u,
                            withApiKey: !1,
                            headers: t.headers
                        })) : r = this._computeRequestHeaders({
                            additionalUA: u,
                            headers: t.headers
                        }), void 0 !== t.body && (o = i(t.body)), n("request start");
                        var y = [],
                            m = function e(c, m) {
                                function v() {
                                    return n("retrying request"), p._incrementHostIndex(t.hostType), e(c, m)
                                }
                                p._checkAppIdData();
                                var g, b = new Date;
                                if (p._useCache && (g = t.url), p._useCache && o && (g += "_body_" + m.body), p._useCache && l && void 0 !== l[g]) return n("serving response from cache"), p._promise.resolve(JSON.parse(l[g]));
                                if (d >= p.hosts[t.hostType].length) return !f || h ? (n("could not get any response"), p._promise.reject(new a.AlgoliaSearchError("Cannot connect to the AlgoliaSearch API. Send an email to support@algolia.com to report and resolve the issue. Application id was: " + p.applicationID, {
                                    debugData: y
                                }))) : (n("switching to fallback"), d = 0, m.method = t.fallback.method, m.url = t.fallback.url, m.jsonBody = t.fallback.body, m.jsonBody && (m.body = i(m.jsonBody)), r = p._computeRequestHeaders({
                                    additionalUA: u,
                                    headers: t.headers
                                }), m.timeouts = p._getTimeoutsForRequest(t.hostType), p._setHostIndexByType(0, t.hostType), h = !0, e(p._request.fallback, m));
                                var w = p._getHostByType(t.hostType),
                                    _ = w + m.url,
                                    x = {
                                        body: m.body,
                                        jsonBody: m.jsonBody,
                                ...
                                return n("method: %s, url: %s, headers: %j, timeouts: %d", x.method, _, x.headers, x.timeouts), c === p._request.fallback && n("using fallback"), c.call(p, _, x).then(function (e) {
                                    ...
                                    if (y.push({
                                        ...
                                        duration: c - b,
                                        statusCode: t
                                    }), i) return p._useCache && l && (l[g] = e.responseText), e.body;
                                    if (4 !== Math.floor(t / 100)) return d += 1, v();
                                    n("unrecoverable error");
                                    var u = new a.AlgoliaSearchError(e.body && e.body.message, {
                                        debugData: y,
                                        statusCode: t
                                    });
                                    return p._promise.reject(u)
                                }, function (i) {
                                    n("error: %s, stack: %s", i.message, i.stack);
                                    var u = new Date;
                                    return y.push({
                                        currentHost: w,
                                        headers: s(r),
                                        ...
                                        endTime: u,
                                        duration: u - b
                                    }), i instanceof a.AlgoliaSearchError || (i = new a.Unknown(i && i.message, i)), d += 1, i instanceof a.Unknown || i instanceof a.UnparsableJSON || d >= p.hosts[t.hostType].length && (h || !f) ? (i.debugData = y, p._promise.reject(i)) : i instanceof a.RequestTimeout ? (n("retrying request with higher timeout"), p._incrementHostIndex(t.hostType), p._incrementTimeoutMultipler(), m.timeouts = p._getTimeoutsForRequest(t.hostType), e(c, m)) : v()
                                })
                            }(p._request, {
                                url: t.url,
                                method: t.method,
                        ...
                        return "function" != typeof t.callback ? m : void m.then(function (e) {
                            c(function () {
                                t.callback(null, e)
                        ...
                        return !1 !== t.withApiKey && (r["x-algolia-api-key"] = this.apiKey), this.userToken && (r["x-algolia-usertoken"] = this.userToken), this.securityTags && (r["x-algolia-tagfilters"] = this.securityTags), o(this.extraHeaders, function (e, t) {
                            r[t] = e
                        }), t.headers && o(t.headers, function (e, t) {
                            r[t] = e
                        }), r
                        ...
                        var s = this,
                            ...
                            u = "/1/indexes/*/queries";
                        return void 0 !== o.strategy && (u += "?strategy=" + o.strategy), this._jsonRequest({
                            cache: this.cache,
                            method: "POST",
                            url: u,
                            body: a,
                        ...
                        var e = l.get(this.applicationID);
                        return null !== e && this._cacheAppIdData(e), e
                    }, r.prototype._setAppIdData = function (e) {
                        return e.lastChange = (new Date).getTime(), this._cacheAppIdData(e), l.set(this.applicationID, e)
                        ...
                        var r = e(25)(this._hostIndexes);
                        return r[o] = t, this._partialAppIdDataUpdate({
                            hostIndexes: r
                        }), t
        ...
        16: [
            function (e, t, o) {
                ...
                t.exports = r, i(r, s), r.prototype.addObject = function (e, t, o) {
                    ...
                    for (var n = {
                        ...
                        var s = {
                            action: !0 === o ? "partialUpdateObject" : "partialUpdateObjectNoCreate",
                    ...
                    if ("function" == typeof e || "string" != typeof e && "number" != typeof e) {
                        var o = new l.AlgoliaSearchError("Cannot delete an object without an objectID");
                ...
                }, r.prototype.deleteByQuery = a(function (t, o, r) {
                    function n(e) {
                        return c.waitTask(e.taskID)
                    }

                    function i() {
                        return c.deleteByQuery(t, o)
                    }
                    var s = e(25),
                        a = e(30),
                        c = this,
                        l = c.as;
                    1 === arguments.length || "function" == typeof o ? (r = o, o = {}) : o = s(o), o.attributesToRetrieve = "objectID", o.hitsPerPage = 1e3, o.distinct = !1, this.clearCache();
                    var p = this.search(t, o).then(function (e) {
                        if (0 === e.nbHits) return e;
                        var t = a(e.hits, function (e) {
                            return e.objectID
                        });
                        return c.deleteObjects(t).then(n).then(i)
                    });
                    return r ? void p.then(function () {
                        u(function () {
                            r(null)
                ...
                }, c("index.deleteByQuery()", "index.deleteBy()")), r.prototype.deleteBy = function (e, t) {
                    return this.as._jsonRequest({
                        method: "POST",
                    ...
                    function n(e, t) {
                        if (!s._stopped) return e ? void s._error(e) : (s._result(t), void 0 === t.cursor ? void s._end() : void r(t.cursor))
                    }
                    ...
                    var i = e(31),
                        ...
                        a = this.as,
                        c = this,
                        u = a._getSearchParams(i({}, o || {}, {
                            query: t
                        }), "");
                    return r(), s
                }, r.prototype.ttAdapter = a(function (e) {
                    var t = this;
                    return function (o, r, n) {
                        var i;
                    ...
                    return t ? void a.then(function (e) {
                        u(function () {
                            t(null, e)
                    ...
                    return this.listApiKeys(e)
                }, c("index.listUserKeys()", "index.listApiKeys()")), r.prototype.listApiKeys = function (e) {
                    return this.as._jsonRequest({
                        method: "GET",
                    ...
                    return this.getApiKey(e, t)
                }, c("index.getUserKeyACL()", "index.getApiKey()")), r.prototype.getApiKey = function (e, t) {
                    return this.as._jsonRequest({
                        method: "GET",
                    ...
                    return this.deleteApiKey(e, t)
                }, c("index.deleteUserKey()", "index.deleteApiKey()")), r.prototype.deleteApiKey = function (e, t) {
                    return this.as._jsonRequest({
                        method: "DELETE",
                        url: "/1/indexes/" + encodeURIComponent(this.indexName) + "/keys/" + e,
                        hostType: "write",
                ...
                }, r.prototype.addUserKey = a(function (e, t, o) {
                    return this.addApiKey(e, t, o)
                }, c("index.addUserKey()", "index.addApiKey()")), r.prototype.addApiKey = function (t, o, r) {
                    if (!e(8)(t)) throw new Error("Usage: index.addApiKey(arrayOfAcls[, params, callback])");
                    1 !== arguments.length && "function" != typeof o || (r = o, o = null);
                    var n = {
                        acl: t
                    };
                    return o && (n.validity = o.validity, n.maxQueriesPerIPPerHour = o.maxQueriesPerIPPerHour, n.maxHitsPerQuery = o.maxHitsPerQuery, n.description = o.description, o.queryParameters && (n.queryParameters = this.as._getSearchParams(o.queryParameters, "")), n.referers = o.referers), this.as._jsonRequest({
                        method: "POST",
                        url: "/1/indexes/" + encodeURIComponent(this.indexName) + "/keys",
                        body: n,
                        hostType: "write",
                ...
                }, r.prototype.addUserKeyWithValidity = a(function (e, t, o) {
                    return this.addApiKey(e, t, o)
                }, c("index.addUserKeyWithValidity()", "index.addApiKey()")), r.prototype.updateUserKey = a(function (e, t, o, r) {
                    return this.updateApiKey(e, t, o, r)
                }, c("index.updateUserKey()", "index.updateApiKey()")), r.prototype.updateApiKey = function (t, o, r, n) {
                    if (!e(8)(o)) throw new Error("Usage: index.updateApiKey(key, arrayOfAcls[, params, callback])");
                    2 !== arguments.length && "function" != typeof r || (n = r, r = null);
                    var i = {
                        acl: o
                    };
        ...
        17: [
            function (e, t, o) {
                ...
                function r() {}
                t.exports = r;
                e(7)(r, e(4).EventEmitter), r.prototype.stop = function () {
        ...
        18: [
            function (e, t, o) {
                ...
                t.exports = r, r.prototype.clearCache = function () {
                    ...
                    var a = this.as._getSearchParams(o, "");
                    return this.as._jsonRequest({
                        method: "POST",
                ...
                (function (o) {
                    ...
                    t.exports = function (t, i) {
                        function s(t, o, r) {
                            var n = e(25),
                                i = e(21);
                            return void 0 === (r = n(r || {})).protocol && (r.protocol = i()), r._ua = r._ua || s.ua, new a(t, o, r)
                        }
                        ...
                        return h.hasXMLHttpRequest && (h.cors = "withCredentials" in new XMLHttpRequest), c(a, t), a.prototype._request = function (e, t) {
                            return new n(function (o, r) {
                                function n() {
                                    a = !0, p.abort(), r(new u.RequestTimeout)
                                }

                                function i() {
                                    d = !0, clearTimeout(s), s = setTimeout(n, t.timeouts.complete)
                                }
                                if (h.cors || h.hasXDomainRequest) {
                                    e = l(e, t.headers);
                                    var s, a, c = t.body,
                                        p = h.cors ? new XMLHttpRequest : new XDomainRequest,
                                        d = !1;
                                    s = setTimeout(n, t.timeouts.connect), p.onprogress = function () {
                                        d || i()
                                        ...
                                        if (!a) {
                                            ...
                                            try {
                                                e = {
                                                    ...
                                                    statusCode: p.status,
                                                    headers: p.getAllResponseHeaders && p.getAllResponseHeaders() || {}
                                                }
                                            } catch (t) {
                                        ...
                                        a || (clearTimeout(s), r(new u.Network({
                                            more: e
                                        })))
                                    }, p instanceof XMLHttpRequest ? p.open(t.method, e, !0) : p.open(t.method, e), h.cors && (c && ("POST" === t.method ? p.setRequestHeader("content-type", "application/x-www-form-urlencoded") : p.setRequestHeader("content-type", "application/json")), p.setRequestHeader("accept", "application/json")), p.send(c)
                                } else r(new u.Network("CORS not supported"))
                            })
        ...
        23: [
            function (e, t, o) {
                ...
                t.exports = function (e, t, o) {
                    function i() {
                        t.debug("JSONP: success"), d || c || (d = !0, a || (t.debug("JSONP: Fail. Script loaded but did not call the callback"), s(), o(new r.JSONPScriptFail)))
                    }

                    function s() {
                        clearTimeout(h), l.onload = null, l.onreadystatechange = null, l.onerror = null, u.removeChild(l)
                    }
                    if ("GET" === t.method) {
                        t.debug("JSONP: start");
                        var a = !1,
                        ...
                        window[p] = function (e) {
                            return function () {
                                try {
                                    ...
                                    window[p] = window[p + "_loaded"] = void 0
                                }
                            }(), c ? void t.debug("JSONP: Late answer, ignoring") : (a = !0, s(), void o(null, {
                                body: e
                            }))
                        }, e += "&callback=" + p, t.jsonBody && t.jsonBody.params && (e += "&" + t.jsonBody.params);
                        var h = setTimeout(function () {
                            t.debug("JSONP: Script timeout"), c = !0, s(), o(new r.RequestTimeout)
                        }, t.timeouts.complete);
                        l.onreadystatechange = function () {
                            "loaded" !== this.readyState && "complete" !== this.readyState || i()
                        }, l.onload = i, l.onerror = function () {
                            t.debug("JSONP: Script error"), d || c || (s(), o(new r.JSONPScriptError))
                        }, l.async = !0, l.defer = !0, l.src = e, u.appendChild(l)
                    } else o(new Error("Method " + t.method + " " + e + " is not supported by JSONP."))
                };
                var r = e(28),
                    n = 0
            }, {
            ...
            function (e, t, o) {
                t.exports = function (e, t) {
                    return function (o, n, i) {
                        if ("function" == typeof o && "object" == typeof n || "object" == typeof i) throw new r.AlgoliaSearchError("index.search usage is index.search(query, params, cb)");
                        0 === arguments.length || "function" == typeof o ? (i = o, o = "") : 1 !== arguments.length && "function" != typeof n || (i = n, n = void 0), "object" == typeof o && null !== o ? (n = o, o = void 0) : void 0 !== o && null !== o || (o = "");
                        var s = "";
            ...
            function (e, t, o) {
                ...
                t.exports = function e(t) {
                    ...
                    return r(o, function (o) {
                        for (var r in o) o.hasOwnProperty(r) && ("object" == typeof t[r] && "object" == typeof o[r] ? t[r] = e({}, t[r], o[r]) : void 0 !== o[r] && (t[r] = o[r]))
                    }), t
                }
            }, {
                5: 5
        ...
        33: [
            function (e, t, o) {
                t.exports = function (t) {
                    return function (o, n, i) {
                        var s = e(25);
                        (i = i && s(i) || {}).hosts = i.hosts || ["places-dsn.algolia.net", "places-1.algolianet.com", "places-2.algolianet.com", "places-3.algolianet.com"], 0 !== arguments.length && "object" != typeof o && void 0 !== o || (o = "", n = "", i._allowEmptyCredentials = !0);
                        var a = t(o, n, i).initIndex("places");
                        return a.search = r("query", "/1/places/query"), a.getObject = function (e, t) {
                            return this.as._jsonRequest({
                                method: "GET",
        ...
        34: [
            function (e, t, o) {
                (function (o) {
                    function r(e, t) {
                        return a("localStorage failed with", t),
                            function () {
                                try {
                                    o.localStorage.removeItem(c)
                                } catch (e) {}
                            }(), (s = u).get(e)
                    }
                    ...
                    function i() {
                        try {
                            return "localStorage" in o && null !== o.localStorage && (o.localStorage[c] || o.localStorage.setItem(c, JSON.stringify({})), !0)
                        } catch (e) {
                            return !1
                        }
                    }
                    var s, a = e(1)("algoliasearch:src/hostIndexState.js"),
                        ...
                        l = {
                            set: function (e, t) {
                                u.set(e, t);
                                try {
                                    var n = JSON.parse(o.localStorage[c]);
                                    return n[e] = t, o.localStorage[c] = JSON.stringify(n), n[e]
                                } catch (t) {
                                    return r(e, t)
                                }
                            }, get: function (e) {
                                try {
                                    return JSON.parse(o.localStorage[c])[e] || null
                                } catch (t) {
                                    return r(e, t)
                                }
                            }
