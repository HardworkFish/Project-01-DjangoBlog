    ...
    return function e(t, o, r) {
        ...
        2: [
            function (e, t, o) {
                function r(e) {
                    ...
                    return !1
                }, o.humanize = e(8), o.names = [], o.skips = [], o.formatters = {};
                var n
            }, {
                8: 8
            }
            ...
            function (e, t, o) {
                (function (r, n) {
                    i = this, s = function () {
                        ...
                        function l(e, o, r) {
                            o.constructor === e.constructor && r === s && o.constructor.resolve === a ? (c = e, (u = o)._state === U ? d(c, u._result) : u._state === D ? h(c, u._result) : y(u, void 0, function (e) {
                                return p(c, e)
                            }, function (e) {
                                return h(c, e)
                            })) : r === M ? (h(e, M.error), M.error = null) : void 0 === r ? d(e, o) : t(r) ? (n = o, i = r, j(function (e) {
                                var t = !1,
                                    o = function (e, t, o, r) {
                                        try {
                                            e.call(t, o, r)
                        ...
                        function p(e, t) {
                            e === t ? h(e, new TypeError("You cannot resolve a promise with itself")) : function (e) {
                                var t = typeof e;
                        ...
                        function d(e, t) {
                            e._state === P && (e._result = t, e._state = U, 0 !== e._subscribers.length && j(m, e))
                        }

                        function h(e, t) {
                            e._state === P && (e._state = D, e._result = t, j(f, e))
                        }

                        function y(e, t, o, r) {
                            var n = e._subscribers,
                                i = n.length;
                            e._onerror = null, n[i] = t, n[i + U] = o, n[i + D] = r, 0 === i && e._state && j(m, e)
                        }
                        ...
                        function m(e) {
                            var t = e._subscribers,
                                o = e._state;
                            if (0 !== t.length) {
                                for (var r = void 0, n = void 0, i = e._result, s = 0; s < t.length; s += 3) r = t[s], n = t[s + o], r ? v(o, r, n, i) : n(i);
                        ...
                        function v(e, o, r, n) {
                            ...
                            if (i) {
                                ...
                                }(r, n)) === H ? (u = !0, a = s.error, s.error = null) : c = !0, o === s) return void h(o, new TypeError("A promises callback cannot return that same promise."))
                            } else s = n, c = !0;
                            o._state !== P || (i && c ? p(o, s) : u ? h(o, a) : e === U ? d(o, s) : e === D && h(o, s))
                        }
                        ...
                        function _(e) {
                            this[q] = J++, this._result = this._state = void 0, this._subscribers = [], c !== e && ("function" != typeof e && function () {
                        ...
                        var T = Array.isArray ? Array.isArray : function (e) {
                            ...
                            A = void 0,
                            j = function (e, t) {
                                C[x] = e, C[x + 1] = t, 2 === (x += 2) && (A ? A(i) : N())
                            },
                            O = "undefined" != typeof window ? window : void 0,
                            k = O || {},
                            I = k.MutationObserver || k.WebKitMutationObserver,
                            E = "undefined" == typeof self && void 0 !== r && "[object process]" === {}.toString.call(r),
                        ...
                        return w.prototype._enumerate = function (e) {
                            ...
                            if (r === a) {
                                var n = u(e);
                                if (n === s && e._state !== P) this._settledAt(e._state, t, e._result);
                            ...
                            var r = this.promise;
                            r._state === P && (this._remaining--, e === D ? h(r, o) : this._result[t] = o), 0 === this._remaining && d(r, this._result)
                        }, w.prototype._willSettleAt = function (e, t) {
                            var o = this;
                            y(e, void 0, function (e) {
                                return o._settledAt(U, t, e)
                            }, function (e) {
                ...
                var r = Object.prototype.hasOwnProperty,
                    ...
                    h = function (e) {
                        ...
                        if (i && e.length > 0)
                            ...
                            for (var g in e) h && "prototype" === g || !r.call(e, g) || f.push(String(g)); if (c)
                            ...
                            }(e), b = 0; b < l.length; ++b) v && "constructor" === l[b] || !r.call(e, l[b]) || f.push(l[b]);
                        return f
                    };
                h.shim = function () {
                    if (Object.keys) {
        ...
        11: [
            function (e, t, o) {
                ...
                function s() {
                    y && d && (y = !1, d.length ? h = d.concat(h) : m = -1, h.length && a())
                }
                ...
                (function (o) {
                    ...
                    r.prototype.initIndex = function (e) {
                        ...
                        var o, r, n = e(1)("algoliasearch:" + t.url),
                            ...
                            f = 0,
                            d = !1,
                            h = p._useFallback && p._request.fallback && t.fallback;
                        ...
                        var y = [],
                            m = function e(c, m) {
                                ...
                                p._checkAppIdData();
                                var v, b = new Date;
                                if (p._useCache && (v = t.url), p._useCache && o && (v += "_body_" + m.body), p._useCache && l && void 0 !== l[v]) return n("serving response from cache"), p._promise.resolve(JSON.parse(l[v]));
                                if (f >= p.hosts[t.hostType].length) return !h || d ? (n("could not get any response"), p._promise.reject(new a.AlgoliaSearchError("Cannot connect to the AlgoliaSearch API. Send an email to support@algolia.com to report and resolve the issue. Application id was: " + p.applicationID, {
                                    debugData: y
                                }))) : (n("switching to fallback"), f = 0, m.method = t.fallback.method, m.url = t.fallback.url, m.jsonBody = t.fallback.body, m.jsonBody && (m.body = i(m.jsonBody)), r = p._computeRequestHeaders({
                                    additionalUA: u,
                                    headers: t.headers
                                }), m.timeouts = p._getTimeoutsForRequest(t.hostType), p._setHostIndexByType(0, t.hostType), d = !0, e(p._request.fallback, m));
                                ...
                                return n("method: %s, url: %s, headers: %j, timeouts: %d", T.method, _, T.headers, T.timeouts), c === p._request.fallback && n("using fallback"), c.call(p, _, T).then(function (e) {
                                    ...
                                    if (y.push({
                                        ...
                                        duration: c - b,
                                        statusCode: t
                                    }), i) return p._useCache && l && (l[v] = e.responseText), e.body;
                                    if (4 !== Math.floor(t / 100)) return f += 1, g();
                                    ...
                                    return y.push({
                                        ...
                                        endTime: u,
                                        duration: u - b
                                    }), i instanceof a.AlgoliaSearchError || (i = new a.Unknown(i && i.message, i)), f += 1, i instanceof a.Unknown || i instanceof a.UnparsableJSON || f >= p.hosts[t.hostType].length && (d || !h) ? (i.debugData = y, p._promise.reject(i)) : i instanceof a.RequestTimeout ? (n("retrying request with higher timeout"), p._incrementHostIndex(t.hostType), p._incrementTimeoutMultipler(), m.timeouts = p._getTimeoutsForRequest(t.hostType), e(c, m)) : g()
                                })
                            }(p._request, {
                                url: t.url,
                                method: t.method,
            ...
            function (e, t, o) {
                (function (o) {
                    ...
                    t.exports = function (t, i) {
                        ...
                        return d.hasXMLHttpRequest && (d.cors = "withCredentials" in new XMLHttpRequest), c(a, t), a.prototype._request = function (e, t) {
                            return new n(function (o, r) {
                                ...
                                function i() {
                                    f = !0, clearTimeout(s), s = setTimeout(n, t.timeouts.complete)
                                }
                                if (d.cors || d.hasXDomainRequest) {
                                    e = l(e, t.headers);
                                    var s, a, c = t.body,
                                        p = d.cors ? new XMLHttpRequest : new XDomainRequest,
                                        f = !1;
                                    ...
                                    }, p instanceof XMLHttpRequest ? p.open(t.method, e, !0) : p.open(t.method, e), d.cors && (c && ("POST" === t.method ? p.setRequestHeader("content-type", "application/x-www-form-urlencoded") : p.setRequestHeader("content-type", "application/json")), p.setRequestHeader("accept", "application/json")), p.send(c)
        ...
        19: [
            function (e, t, o) {
                ...
                t.exports = function (e, t, o) {
                    function i() {
                        t.debug("JSONP: success"), f || c || (f = !0, a || (t.debug("JSONP: Fail. Script loaded but did not call the callback"), s(), o(new r.JSONPScriptFail)))
                    }

                    function s() {
                        clearTimeout(d), l.onload = null, l.onreadystatechange = null, l.onerror = null, u.removeChild(l)
                    }
                    if ("GET" === t.method) {
                        t.debug("JSONP: start");
                        var a = !1,
                        ...
                        l.onreadystatechange = function () {
                            ...
                            t.debug("JSONP: Script error"), f || c || (s(), o(new r.JSONPScriptError))
